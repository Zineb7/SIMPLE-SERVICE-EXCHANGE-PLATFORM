...
<div
    class="mx-0 py-5 px-3 mx-ns-4 bg-gradient-light shadow blur d-flex w-100 justify-content-center align-items-center flex-column">
    <img src="<?= validate_image(isset($avatar) ? $avatar : '') ?>" alt="" class="img-thumbnail rounded-circle p-0"
        id="profile-avatar">
    <h3 class="text-center font-weight-bolder">
        <?= isset($name) ? $name : '' ?>
    </h3>
    <div class="text-center font-weight-light text-muted">
        <?= isset($email) ? $email : '' ?>
    </div>
</div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if ($check_cancelled_qry->num_rows > 0) {
                                                    ...
                                                    echo '<button class="btn btn-secondary btn-action btn-fixed-width" style="background-color: #007bff !important; border-color: #007bff !important;" disabled>Asked Finish</button>';
                                                } elseif ($row['status'] == 1) {
                                            ...
                                            <td>
                                                ...
                                                if ($check_coin_list_qry->num_rows > 0) {
                                                    ...
                                                    echo '<button class="btn btn-danger btn-action btn-fixed-width"style="background-color: #dc3545 !important; border-color: #dc3545 !important;" disabled> Cancelled</button>';
                                                } elseif ($row['status'] == 1) {
